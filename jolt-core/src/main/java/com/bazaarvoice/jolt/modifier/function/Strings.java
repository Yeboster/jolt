...
public class Strings {
    ...
    public static final class concatIfAllNotEmpty extends Function.ListFunction {
        @Override
        protected Optional<Object> applyList(final List<Object> argList) {
            boolean canConcact = argList.stream().allMatch(arg -> arg != null && !arg.toString().isEmpty());
            if (canConcact) {
                StringBuilder sb = new StringBuilder();
                for (Object arg : argList) {
                    sb.append(arg.toString());
    ...
    public static final class substring extends Function.ListFunction {
        ...
        protected Optional<Object> applyList(List<Object> argList) {
            ...
            do {
                ...
                if (!(argList.get(0) instanceof String && argList.get(1) instanceof Integer
    ...
    private static Optional<Object> padString(boolean leftPad, String source, List<Object> args) {
        ...
        do {
            ...
            if (!(args.get(0) instanceof Integer && args.get(1) instanceof String)) {
                break;
            }
